...
export const Toggle = () => {
  ...
  return (
    <div
      className={cn(
        "w-[210px] flex items-center justify-between transition-all duration-300 p-4",
        collapse && "w-28"
      )}
    >
      ...
      <div>
        <button onClick={handleClick}>
          <SidebarOpen className="stroke-white/60 hover:stroke-white transition-all duration-300" />
        </button>
      </div>
    </div>
  );
