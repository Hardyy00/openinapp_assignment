          ...
          <div className="overflow-x-auto bg-background rounded-lg p-4">
            <div className="table border w-full table-auto border-spacing-2 overflow-x-auto">
              <div className="table-header-group">
                <div className="table-row">
                  {headings?.map((item, idx) => (
                    <div
                      key={idx}
                      className="table-cell font-medium text-lg border border-white px-4 py-2"
                    >
                      {" "}
                      {item as string}
                    </div>
              ...
              <div className="table-row-group space-y-4">
                {rows?.map((item, i) => (
                  <div key={i} className="table-row border border-white">
                    <div className="text-sm table-cell border-white">
                      {item[0] as string}
                    </div>
