      ...
      {data && (
        <div className="py-4 px-8 font-bold text-2xl space-y-8">
          ...
          <div className="overflow-x-auto bg-background rounded-lg p-4">
            <div className="table border w-full border-spacing-2 overflow-x-auto">
                  ...
                  {headings?.map((item, idx) => (
                    <div
                      ...
                      className={cn(
                        ...
                        idx === 0 && "sticky left-0 bg-background-muted"
                      )}
                    >
                      {" "}
                      {item as string}
                ...
                {rows?.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={cn(
                          "text-sm table-cell border-white p-2 sticky -left-2 bg-background-muted"
                        )}
                      >
                        {item[0] as string}
                      </div>
