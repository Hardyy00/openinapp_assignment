      ...
      {data && (
        <div className="py-4 px-8 font-bold text-2xl space-y-8">
          ...
          <div className="overflow-x-auto bg-background rounded-lg p-4">
            <div className="table  w-full overflow-x-auto border-spacing-y-4 text-background-muted">
                ...
                {rows?.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={cn(
                          "text-sm table-cell border-white p-2 sticky -left-4 bg-background-muted z-10 min-w-[6rem] px-4"
                        )}
                      >
                        {item[0] as string}
                      </div>
                      <div className="text-sm table-cell p-2 min-w-[20rem]">
                        {
                          <a
                      ...
                      <div className="table-cell text-sm  border-white p-2 min-w-[14rem]">
                        {item[2] as string}
                      </div>

                      <div className="table-cell p-2 min-w-[14rem]">
                        <Select
                      ...
                      <div className="p-2 flex gap-x-1 text-background-muted min-w-[10rem]">
                        {selectedTags[i].map((item, idx) => (
                          <div
                            key={idx}
                            className="flex items-center gap-x-1 text-sm font-light bg-purple-500 w-fit px-1 py-1/2 rounded-md"
                          >
                            {item}
