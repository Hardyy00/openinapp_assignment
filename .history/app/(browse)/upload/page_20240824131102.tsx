      ...
      {data && (
        <div className="py-4 px-8 font-bold text-2xl space-y-8">
          ...
          <div className="overflow-x-auto bg-background rounded-lg p-4">
            <div className="table  w-full overflow-x-auto border-spacing-y-4">
              ...
              <div className="table-row-group space-y-4 overflow-x-auto rounded-md">
                {rows?.map((item, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={cn(
                          "text-sm table-cell border-white p-2 sticky -left-4 bg-background-muted"
                        )}
                      >
                        {item[0] as string}
                      </div>
