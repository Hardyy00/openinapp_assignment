    ...
    <div className="h-full p-8">
      <div className="p-8 border h-full flex items-center justify-center">
        <div className="flex flex-col gap-y-4">
          ...
          <div className="flex w-full justify-around flex items-center justify-center ">
            <div className="h-10 w-10 p-1 border rounded-[4rem] lg:bg-gray-500">
              <div className="h-8 w-8  relative">
                <Image src={"/github.svg"} alt="svg" fill />
              </div>
            </div>

            <div className="h-10 w-10 p-1 border rounded-[4rem] flex items-center justify-center">
