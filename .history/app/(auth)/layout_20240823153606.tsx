      ...
      <div className="flex-[0.5] p-8">
        <div className="p-8 bg-blue-600 h-full rounded-3xl">
          <div className="p-4 bg-blue-700 h-full rounded-3xl flex flex-col gap-y-4 justify-between">
            ...
            <div className=" flex h-[24rem] border border-white">
              <div className="flex-[0.3] self-end pb-16 border border-white">
                <ThemeToggle />
              </div>
              <div className="flex-1 h-[70%] self-end">
                <div className="h-[70%]">
                  <div className="border border-white relative h-[70%] ">
