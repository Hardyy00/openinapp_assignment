...
export default function Page() {
  ...
  return (
    <div className="h-full p-8 light:bg-gray-100">
      <div className="px-8 py-0 border h-full flex items-center justify-center">
        <div className="flex flex-col gap-y-4 h-full border">
          ...
          <div className="w-full">
            <div className="flex w-full justify-around self-end ">
