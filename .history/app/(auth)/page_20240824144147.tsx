...
export default function Page() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (
      ...
      toast.error("Your Email seems to has some errors.");
      return;
    }
        ...
        <div className="flex flex-col gap-y-8 lg:gap-y-8 h-full">
          ...
          <div className="flex lg:gap-x-8 gap-x-4">
            <form action={signin}>
              ...
              <Button
                className={cn(
                  "flex items-center py-2 lg:px-6 px-2  lg:space-x-4 space-x-1 rounded-xl bg-back hover:bg-gray-900 text-muted-foreground",
                  matches && "bg-white"
                )}
                variant={"ghost"}
              >
            ...
            <Button
              className={cn(
                "flex items-center py-2 lg:px-6 px-4  lg:space-x-4 space-x-2 rounded-xl bg-back hover:bg-gray-900 text-muted-foreground",
                matches && "bg-white"
              )}
              variant={"ghost"}
            >
