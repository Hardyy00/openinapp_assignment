        ...
        <div className="flex flex-col gap-y-8 lg:gap-y-8 h-full">
          ...
          <div className="flex lg:gap-x-8 gap-x-4">
            ...
            <Button
              ...
              variant={"ghost"}
            >
              <div className="w-5 h-5 relative text-5xl p-4 text-center font-bold from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r bg-clip-text text-transparent">
                <Image
                  src={"/apple.svg"}
                  alt="svg"
                  fill
