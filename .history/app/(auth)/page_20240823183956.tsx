    ...
    <div className="h-full p-8">
      <div className="p-8 border h-full flex items-center justify-center">
        <div className="flex flex-col gap-y-4">
          ...
          <div className="lg:bg-gray-800  p-4 pb-8 rounded-3xl">
          ...
          <div className="flex w-full justify-around  ">
            <div className="h-10 w-10 p-1 border rounded-[4rem] flex items-center justify-center bg-gray-500 hover:bg-gray-200 tansition-all">
              <div className="h-8 w-8  relative">
                <Image src={"/github.svg"} alt="svg" fill />
              </div>
            </div>

            <div className="h-10 w-10 p-1 border rounded-[4rem] flex items-center justify-center bg-gray-500 hover:bg-gray-200">
